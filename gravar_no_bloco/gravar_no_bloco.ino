...
byte block = 1; //bloco que esta gravado o numero do palet
byte buffr[] = {0x50,0x4C,0x54,0x30,0x32, //numero do palet para gravar
0x20,0x20,0x20,           //zeros
0x20,0x20,0x20,0x20,      //zeros
0x20,0x20,0x20,0x20};     //zeros
